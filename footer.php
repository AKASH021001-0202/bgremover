 ...
 <footer class="footer footer-three section pb-0">
     <div class="container">
         <div class="row items-gap align-items-center top-break wow fadeInUp" data-wow-duration="600ms" data-wow-delay="300ms">
         ...
         <div class="row items-gap-two">
             <div class="col-12 col-sm-6 col-lg-4">
                 <div class="footer__single wow fadeInUp" data-wow-duration="600ms">
                     ...
                     <ul>
                         <li>
                             <a href="bg_remover.php"> Background Remover</a>
                         </li>
                         <li>
                             <a href="water_mark.php"> Water Mark Remover</a>
                         </li>
                         <li>
                             <a href="bg_con.php"> Converter</a>
                         </li>
                         <li>
                             <a href="high_resolution.php"> Image Upscale</a>
                         </li>
                     </ul>
                 </div>
             </div>
             <div class="col-12 col-sm-6 col-lg-4">
                 <div class="footer__single wow fadeInUp" data-wow-duration="600ms" data-wow-delay="200ms">
                     <h5 class="h5">About Quick Remover</h5>
                     <ul>
                         <li>
             ...
             <!--     <div class="col-12 col-sm-6 col-lg-3">
                 <div class="footer__single wow fadeInUp" data-wow-duration="600ms" data-wow-delay="400ms">
                     ...
                     <ul>
                         <li>
                             <a href="#"> AI Photo Restorer</a>
                         </li>
                         <li>
                             <a href="#">Toongineer Cartoonizer</a>
                         </li>
                         <li>
                             <a href="#"> VansPortrait</a>
                         </li>
                         <li>
                             <a href="#"> AI Photo Colorizer</a>
                         </li>
                         <li>
                             <a href="#">AI Photo Retoucher</a>
                         </li>
                     </ul>
                 </div>
             </div> -->
     ...
     <div class="copyright text-center">
         <p>
             ...
             <a href="index.php">Bg Remover</a>
             . Design By
             <a href="#">BG Remover Team</a>
         </p>
     </div>
 </footer>
 <!-- ==== / footer end ==== -->
